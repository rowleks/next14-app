    ...
    <div className="md:flex gap-[2rem] w-full">
        ...
        <section className="flex flex-1 flex-col gap-10 items-center lg:items-start">
            ...
            <div className="flex items-center gap-5 text-sm font-medium">
                <Link href="/about" className="px-4.5 py-3.5 bg-txt-btn cursor-pointer border-none rounded-md min-w-32 hover:bg-blue-600 text-center">Learn More</Link>
                <Link href="/contact" className="px-4.5 py-3.5 min-w-32 bg-txt text-primary-soft cursor-pointer border-none rounded-md hover:bg-gray-200 text-center">Contact</Link>
            </div>
